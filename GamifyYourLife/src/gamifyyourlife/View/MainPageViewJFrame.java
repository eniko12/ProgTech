...
public class MainPageViewJFrame extends JFrame {
    //Főoldal
    public JPanel p1;
    JLabel greeting;
    JButton updateAll;
    ...
    public void addUpdateAllBtnListener(ActionListener listenerForUpdateAll){
        updateAll.addActionListener(listenerForUpdateAll);
    }
    ...
    public void setTaskList(ArrayList<String> list){
        ...
        for(int i = 0; i<list.size(); i++){
            ans = ans + "/n" + list.get(i);
        }        
        taskListTA.setText(ans);
    }
